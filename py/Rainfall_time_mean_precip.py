...
cs1 = plt.contourf(lon2d,lat2d,pr_djf,levels = np.arange(0., 250.,10), cmap=plt.cm.rainbow)
#cs1=plt.pcolormesh(lon2d,lat2d,pr_djf)
axa.set_extent([-30,60, -40, 40])
axa.set_xticks(range(-30,60,10), crs=prj)
axa.set_yticks(range(-40,40,10), crs=prj)
